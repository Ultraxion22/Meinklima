...
import style from './styles/Noticias.css';
        ...
        <div>
            ...
            <div className="row d-flex justify-content-center">
                <div className="col-lg-4 col-12 container-news m-3 p-5">
                    ...
                    <div className="d-flex justify-content-center p-lg-4 py-4">
                    <p className="txt-news">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    </div>
                    <div className="d-flex justify-content-center ">
                        <button className="btn-news"> SABER MAS</button>
                    </div>
