...
function Texto() {
    return (
        <div>
            <div className = "row d-flex justify-content-center mt-3 mb-3 me-lg-5 me-sm-2 ms-2">
                <div className = "col-lg-4 col-md-6 col-sm-6 d-flex justify-content-center txt-container">
                <div className = "">
